...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getPosts: function getPosts() {
      ...
      //di base mi carica la pagina 1, poi sotto con params gli posso definire la pagina
      this.loaded = false;
    ...
    formatDate: function formatDate(date) {
      var d = new Date(date); //ottengo la data dei post dal api

      var dy = d.getDate(); //gli passo la data e mi restituisce i giorni

      var m = d.getMonth() + 1; //gli passo la data e mi restituisce i mesi da 0 a 11, per questo gli mettiamo +1

      var y = d.getFullYear(); //gli passo la data e mi restituisce l anno per intero
      ...
      _c(
        ...
        [
          _c("div", { staticClass: "d-flex justify-content-between" }, [
            ...
            _vm._v(" "),
            _c("span", { staticClass: "badge badge-dark custom-badge" }, [
      ...
      _c("div", { staticClass: "card-body" }, [
        ...
        _c(
          ...
          _vm._l(_vm.post.tags, function(tag) {
            return _c(
              "i",
              { key: "t" + tag.id, staticClass: "badge badge-success" },
